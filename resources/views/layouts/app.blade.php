            ...
            <div :class="mobileOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
                ...
                <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                    ...
                    <a href="{{ route('platform.courses') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                              {{ request()->routeIs('platform.courses') ? 'bg-ami-500/10 text-ami-400' : 'text-surface-400 hover:text-white hover:bg-surface-800/60' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <a href="{{ route('live-classes.calendar') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                        ...
                        <span x-show="!collapsed" x-cloak>Calendario</span>
                    </a>

                    {{-- Ranking --}}
                    <a href="{{ route('platform.ranking') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                              {{ request()->routeIs('platform.ranking') ? 'bg-ami-500/10 text-ami-400' : 'text-surface-400 hover:text-white hover:bg-surface-800/60' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div x-data="{ journalOpen: {{ request()->routeIs('journal') || request()->routeIs('bitacora.*') ? 'true' : 'false' }} }">
                        <button @click="journalOpen = !journalOpen"
                            ...
                            <span x-show="!collapsed" x-cloak class="flex-1 text-left">Trading Journal</span>
                            <svg x-show="!collapsed" x-cloak
                                 :class="journalOpen && 'rotate-180'"
                                 class="w-3.5 h-3.5 shrink-0 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </button>

                        <div x-show="journalOpen && !collapsed" x-cloak x-collapse class="ml-5 mt-1 space-y-0.5 border-l border-surface-700/50 pl-3">
                            @if(config('journal.enabled'))
                            <a href="{{ route('journal') }}"
                               class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-all duration-200
                                      {{ request()->routeIs('journal') && !request()->routeIs('journal.stats') ? 'text-ami-400 bg-ami-500/5' : 'text-surface-400 hover:text-white hover:bg-surface-800/60' }}">
                            ...
                            <a href="{{ route('journal.stats') }}"
                               class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-all duration-200
                                      {{ request()->routeIs('journal.stats') ? 'text-ami-400 bg-ami-500/5' : 'text-surface-400 hover:text-white hover:bg-surface-800/60' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <a href="{{ route('bitacora.index') }}"
                               class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-all duration-200
                                      {{ request()->routeIs('bitacora.index') || (request()->routeIs('bitacora.*') && !request()->routeIs('bitacora.stats')) ? 'text-ami-400 bg-ami-500/5' : 'text-surface-400 hover:text-white hover:bg-surface-800/60' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <a href="{{ route('bitacora.stats') }}"
                               class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-all duration-200
                                      {{ request()->routeIs('bitacora.stats') ? 'text-ami-400 bg-ami-500/5' : 'text-surface-400 hover:text-white hover:bg-surface-800/60' }}">
                                <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
                                </svg>
                                Stats Manual
